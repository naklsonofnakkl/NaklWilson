...
function writeNav(imageToggle) {
    ...
    function eyeButton() {
      if (pg > 0) {
          return `<a href="archive.html"/>` + imgOrText(imageToggle, 2) + `</a>`;
      } else {
          if (!imageToggle) {
    ...
    function nextButton() {
        ...
        if (pg < maxpg) {
            ...
            return `<a href="?pg=` + (pg + 1) + navScrollTo + `"/>` + imgOrText(imageToggle, 3) + `</a>`;
        } else {
            if (!imageToggle) {
    ...
    function lastButton() {
        ...
        if (pg < maxpg) {
            ...
            return `<a href="?pg=` + maxpg + navScrollTo + `"/>` + imgOrText(imageToggle, 4) + `</a>`;
        } else {
            if (!imageToggle) {
                return imgOrText(imageToggle, 4);
            } else {
                return ``;
            }
        }
