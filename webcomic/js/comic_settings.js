...
const thumbExt = "jpg" //file extension of thumbnails
...
//NAVIGATION SETTINGS
const navText = ["First","Previous","Archive","Next","Last"]; //alt text for your nav images, or just the text that shows up if you're not using images
...
const pgData = [
    {
        ...
        title: "COMING SOON PROMO", //the title of the page (leaving this blank will default it to "Page X")
        date: writeDate(2025, 1, 2), //the date on which the page was posted (mainly for the archive). The date is written using a function called "writeDate", basically just put writeDate and then some parenthesis and, comma separated, the year followed by the month and the day. Don't forget another comma at the end outside the parenthesis!
        altText: "EMPATHY - COMING SOON", //the alt text (mouse over text) for this particular comic. put nothing inbetween the quotes for no alt text
        imageFiles: 1, //how many image files this page is split into
        authorNotes: `
            <p>This is an announcement for a new comic series titled Empathy!</p>
            <p>I can't say much beyond that, so stay tuned...</p>
            `,
    },
